...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\subfloat[\centering Matrix size 1000]{{\includegraphics[width=7.5cm]{./images/time_vs_cores_1000} }}%
		\qquad
		\subfloat[\centering Matrix size 10000]{{\includegraphics[width=7.5cm]{./images/time_vs_cores_10000} }}%
	...
	\begin{figure}[H]
		\centering
		\subfloat[\centering Matrix size 1000]{{\includegraphics[width=7.5cm]{./images/speedup_vs_cores_1000} }}%
		\qquad
		\subfloat[\centering Matrix size 10000]{{\includegraphics[width=7.5cm]{./images/speedup_vs_cores_10000} }}%
		\caption{Speedup vs number of workers}%
		\label{fig:speedup}%
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\subfloat[\centering Matrix size 1000]{{\includegraphics[width=7.5cm]{./images/efficiency_vs_cores_1000} }}%
		\qquad
		\subfloat[\centering Matrix size 10000]{{\includegraphics[width=7.5cm]{./images/efficiency_vs_cores_10000} }}%
		\caption{Efficiency vs number of workers}%
		\label{fig:eff}%
	\end{figure}

	\begin{figure}[H]
		\centering
		\includegraphics[width=7.5cm]{./images/speedup_vs_size}
