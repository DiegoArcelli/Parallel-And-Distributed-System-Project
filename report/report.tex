...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\subfloat[\centering label 1]{{\includegraphics[width=6.5cm]{./images/speedup_vs_cores_16384} }}%
		\qquad
		\subfloat[\centering label 2]{{\includegraphics[width=6.5cm]{./images/efficiency_vs_cores_16384} }}%
